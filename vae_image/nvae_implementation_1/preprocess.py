...
class Preprocess(tf.keras.Model):
    def __init__(self, n_encoder_channels, n_blocks, n_cells, scale_factor, input_shape, mult=1, **kwargs) -> None:
        super().__init__(**kwargs)
        
        self.pre_process = Sequential(SpectralNormalization(layers.Conv2D(n_encoder_channels, (3, 3), padding="same")))
